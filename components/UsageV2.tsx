...
const UsageV2: React.FC = () => {
    const steps = [
        {
            number: "01",
            title: "Rulla produkten över hela hårbotten/hårfästet i 2 minuter",
            description: "Använd roll-on applikatorn direkt i hårbotten. Perfekt för vikar, kronan och över hela hårfästet. Inget spill, inget kladd.",
        ...
        },
        {
            ...
            description: "Använd Lumina dagligen. Folliklar behöver daglig signal för att stanna i tillväxtfas. När ser du resultat? Vecka 6-8: Mindre håravfall, första babyhår. Vecka 10-12: Synligt tätare hår vid vikar & krona. Månad 6: Maximal effekt.",
