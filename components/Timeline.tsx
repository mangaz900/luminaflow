      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start bg-medical-50 p-4 md:p-6 rounded-2xl border border-medical-100">
            <div className="bg-medical-900 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg font-serif text-base md:text-lg w-full md:w-auto md:min-w-[120px] text-center">
              Månad 1-2
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start bg-white p-4 md:p-6 rounded-2xl border border-gray-200 shadow-lg md:transform md:scale-105 z-10">
            <div className="bg-medical-500 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg font-serif text-base md:text-lg w-full md:w-auto md:min-w-[120px] text-center">
              Månad 3-4
            </div>
            <div className="flex-1">
